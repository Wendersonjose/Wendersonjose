    ...
    <section id="about" className="c-space section-spacing">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-6 md:auto-rows-[18rem] mt-12">
        ...
        <div className="flex items-end grid-1 grid-default-color">
          ...
          >
            <p className="headtext text-white">Olá, sou o Wenderson.</p>
            <p className="text-white text-sm md:text-base text-pretty">
              Atualmente estou cursando Analise e Desenvolvimento de Sistema e
        ...
        <div className="grid-5 grid-default-color">
          <div className="z-10 w-[50%]">
            ...
            <p className="subtext">
              ...
              JavaScript para fullstack junto com frameworks atuais, buscando construir
